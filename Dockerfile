...
## Copy Namazu to $GOPATH/src/github.com/ampf11111/namazu
RUN mkdir -p $GOPATH/src/github.com/osrg
ADD . $GOPATH/src/github.com/ampf11111/namazu
WORKDIR $GOPATH/src/github.com/ampf11111/namazu
RUN ( git submodule init && git submodule update )
ENV PYTHONPATH $GOPATH/src/github.com/ampf11111/namazu:$PYTHONPATH
