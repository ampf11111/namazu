...
import (
	...
	crun "github.com/ampf11111/namazu/nmz/cli/container/run"
)
...
func (cmd containerCmd) Run(args []string) int {
	if len(args) < 1 {
		fmt.Printf("Usage: nmz container run [OPTIONS] COMMAND [arg...]\n")
		fmt.Printf("\n")
	...
	fmt.Fprintf(os.Stderr, "'%s' is not a nmz container command.\n", args[0])
	return 1
}
